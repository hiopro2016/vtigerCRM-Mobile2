...
class Mobile_WS_SaveRecord extends Mobile_WS_FetchRecordWithGrouping {
	...
	function process(Mobile_API_Request $request) {
		...
		try {
			...
			file_put_contents($_SERVER['DOCUMENT_ROOT']."/logs/log.txt", json_encode($this->recordValues),FILE_APPEND);
			...
			file_put_contents($_SERVER['DOCUMENT_ROOT']."/logs/log.txt", 'resut:'.json_encode($this->recordValues),FILE_APPEND);
